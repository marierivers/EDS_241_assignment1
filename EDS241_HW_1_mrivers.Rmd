...
**The estimated slope coefficient for this model is `r round(slope_coef, 3)`. The heteroskedasticity-robust standard error for this estimated slope coefficient is `r round(std_err, 3)` xxx...include units**
...
**The estimated coefficient on poverty is `r round(p0verty_coef, 3)`. This mean that for a one unit increase in poverty, percent low birth weighth will increase by `r round(poverty_coef, 3)` while holding PM2.5 constanct**  xxx...check/clean up this interpretation
